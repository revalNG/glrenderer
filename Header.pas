{
  ...
  2011-04-19 - Апдейт по текущему экспорту - glrenderer больше не экспортирует
               функции для работы с данными, анимацией, а также с движением
               камеры
}
unit Header;
...
// Из текущей версии убрана реализация данных и анимации
//  //РАБОТА С ДАННЫМИ
//
