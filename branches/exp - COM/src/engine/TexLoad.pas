...
function LoadTexture(const Stream: TdfStream; ext: String; var iFormat,cFormat,dType: TGLConst; var pSize: Integer; var Width, Height: Integer): Pointer; overload;
...
function myLoadBMPTexture(Stream: TdfStream; var Format : TGLConst; var Width, Height: Integer): Pointer;
var
...
function myLoadTGATexture(Stream: TdfStream; var Format: TGLConst; var Width, Height: Integer): Pointer; overload;
var
  //tgaFile: File;
...
function LoadTexture(const Stream: TdfStream; ext: String; var iFormat, cFormat, dType: TGLConst;
