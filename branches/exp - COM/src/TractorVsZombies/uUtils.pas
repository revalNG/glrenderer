...
uses
  UPhysics2D, UPhysics2DTypes, uMyWorld,

  dfHRenderer, dfMath;

{ glRenderer }
function dfNewSpriteWithNode(aParent: IdfNode): IdfSprite; overload;
function dfNewSpriteWithNode(aParent: IdfNode; var ResultNode: IdfNode): IdfSprite; overload;
procedure dfLoadSprite(var aSprite: IdfSprite; aFileName: String; aPos: TdfVec2f; aRot: Single);
...
{ box2d + glrenderer}
function dfb2InitBox(b2World: Tb2World; aSprite: IdfSprite; d, f, r: Double; aDamping, lDamping: Double; mask, category: UInt16): Tb2Body;
function dfb2InitCircle(b2World: Tb2World; aRad: Double; aPos: TdfVec2f; d, f, r: Double; aDamping, lDamping: Double; mask, category: UInt16): Tb2Body; overload;
function dfb2InitCircle(b2World: Tb2World; aSprite: IdfSprite; d, f, r: Double; aDamping, lDamping: Double; mask, category: UInt16): Tb2Body; overload;

implementation

{$REGION ' [glRenderer ] '}

function dfNewSpriteWithNode(aParent: IdfNode): IdfSprite;
var
  rNode: IdfNode;
begin
...
function dfNewSpriteWithNode(aParent: IdfNode; var ResultNode: IdfNode): IdfSprite;
begin
...
function dfb2InitCircle(b2World: Tb2World; aRad: Double; aPos: TdfVec2f; d, f, r: Double; aDamping, lDamping: Double; mask, category: UInt16): Tb2Body;
var
  BodyDef: Tb2BodyDef;
...
function dfb2InitCircle(b2World: Tb2World; aSprite: IdfSprite; d, f, r: Double; aDamping, lDamping: Double; mask, category: UInt16): Tb2Body;
begin
  Result := dfb2InitCircle(b2World, aSprite.Width / 2, aSprite.Position, d, f, r, aDamping, lDamping, mask, Category);
end;
